    ...
    getDailyMeals(date) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const dailyMeal = yield prisma_1.default.dailyMeal.findFirst({
                    where: {
                        date: {
                            gte: startOfDay,
                            lte: endOfDay
    ...
    skipMeal(userId, date, mealType) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const updatedDailyMeal = yield prisma_1.default.dailyMeal.update({
    ...
    createDailyMeal(date, breakfastId, lunchId, dinnerId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const dailyMeal = yield prisma_1.default.dailyMeal.create({
                    data: {
                        date,
                        breakfastId,
                        lunchId,
