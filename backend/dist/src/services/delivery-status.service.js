...
exports.deliveryStatusService = {
    getDeliveryStatus(orderId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const deliveryStatus = yield prisma_1.default.deliveryStatus.findUnique({
                    where: { orderId },
                    include: {
                        deliveryPartner: {
                            select: {
    ...
    updateDeliveryStatus(orderId, status, oldTiffinStatus, deliveryPartnerId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const deliveryStatus = yield prisma_1.default.deliveryStatus.upsert({
                    where: { orderId },
                    update: {
                        status,
                        oldTiffinStatus,
    ...
    getDeliveryPartnerDeliveries(deliveryPartnerId, date) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const deliveries = yield prisma_1.default.deliveryStatus.findMany({
                    where: {
                        deliveryPartnerId,
                        deliveryTime: {
                            gte: startOfDay,
